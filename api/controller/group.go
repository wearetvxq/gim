...
func (GroupController) All(c *context) {
	c.response(service.GroupUserService.ListByUserId(c, c.appId, c.userId))
}
...
func (GroupController) Get(c *context) {
	...
	c.response(service.GroupService.Get(c, c.appId, groupId))
}
...
func (GroupController) Create(c *context) {
	...
	group.AppId = c.appId
	c.response(nil, service.GroupService.Create(c, group))
}
...
func (GroupController) Update(c *context) {
	...
	group.AppId = c.appId
	c.response(nil, service.GroupService.Update(c, group))
}
...
func (GroupController) AddUser(c *context) {
	...
	c.response(nil, service.GroupService.AddUser(c, c.appId, add.GroupId, add.UserId, add.Label, add.Extra))
}
...
func (GroupController) DeleteUser(c *context) {
	...
	c.response(nil, service.GroupService.DeleteUser(c, c.appId, update.GroupId, update.UserId))
}
...
func (GroupController) UpdateUser(c *context) {
	...
	err := service.GroupService.UpdateUser(c, c.appId, update.GroupId, c.userId, update.Label, update.Extra)
	c.response(nil, err)
}
